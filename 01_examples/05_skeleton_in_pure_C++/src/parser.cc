...
#line 336 "src\\parser.cc"
        break;

      case symbol_kind::S_exp: // exp
#line 33 "grammar\\parser.yy"
                 { yyo << yysym.value.template as < int > (); }
#line 342 "src\\parser.cc"
        break;
...
#line 52 "grammar\\parser.yy"
                       { cDriver.m_cApp.m_iResult = yystack_[0].value.as < int > (); }
...
#line 59 "grammar\\parser.yy"
                        { cDriver.m_cApp.m_mapVariables[yystack_[2].value.as < std::string > ()] = yystack_[0].value.as < int > (); }
...
#line 63 "grammar\\parser.yy"
                  { yylhs.value.as < int > () = cDriver.m_cApp.m_mapVariables[yystack_[0].value.as < std::string > ()]; }
