...
#line 52 "grammar\\parser.yy"
                       { drv.m_iResult = yystack_[0].value.as < int > (); }
...
#line 59 "grammar\\parser.yy"
                          { drv.m_mapVariables[yystack_[2].value.as < std::string > ()] = yystack_[0].value.as < int > (); }
...
#line 63 "grammar\\parser.yy"
                    { yylhs.value.as < int > () = drv.m_mapVariables[yystack_[0].value.as < std::string > ()]; }
