...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_TK_IDENTIFIER = 5,              /* TK_IDENTIFIER  */
  YYSYMBOL_TK_EQUAL = 6,                   /* TK_EQUAL  */
  YYSYMBOL_7_ = 7,                         /* '='  */
...
static const char *const yytname[] =
{
  ...
  "TK_FLOAT", "TK_IDENTIFIER", "TK_EQUAL", "'='", "$accept", "input",
...
yyreduce:
  ...
  switch (yyn)
    {
  case 4: /* assignment: TK_IDENTIFIER '=' TK_INTEGER  */
#line 38 "grammar\\parser.y"
                                        { ssOutput << "Integer assignemnt : " << (yyvsp[-2].strVal) << " = " << (yyvsp[0].iVal) << std::endl; }
#line 1192 "src\\parser.cpp"
    break;

  case 5: /* assignment: TK_IDENTIFIER '=' TK_FLOAT  */
#line 39 "grammar\\parser.y"
                                            { ssOutput << "Float assignemnt : " << (yyvsp[-2].strVal) << " = " << (yyvsp[0].dVal) << std::endl; }
