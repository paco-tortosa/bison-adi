      ...
      try
#endif // YY_EXCEPTIONS
        {
          switch (yyn)
            {
  case 2: // input: %empty
#line 65 "grammar\\parser.yy"
                            {}
#line 633 "src\\parser.cc"
    break;

  case 3: // input: input "\n"
#line 66 "grammar\\parser.yy"
                            {}
#line 639 "src\\parser.cc"
    break;

  case 4: // input: input assignment "\n"
#line 67 "grammar\\parser.yy"
                            {   }
#line 645 "src\\parser.cc"
    break;

  case 5: // assignment: CELL "=" expr
#line 71 "grammar\\parser.yy"
                            {
                                std::cout << yystack_[2].value.as < std::string > () << " = ";
                                yystack_[0].value.as < std::shared_ptr<cExpr_t> > ()->m_Print();
                                std::cout << std::endl; 
                            }
...
#line 761 "src\\parser.cc"
    break;

  case 16: // args: expr
#line 138 "grammar\\parser.yy"
                            {   
...
#line 769 "src\\parser.cc"
  ...
  case 17: // args: args "," expr
#line 141 "grammar\\parser.yy"
                            {   
...
#undef YYCASE_
  ...
  parser::yypact_[] =
  {
     -11,     4,   -11,   -11,   -10,    -3,     2,   -11,     2,     2,
     -11,    11,    13,    27,   -11,    21,     2,    19,     2,     2,
       2,     2,   -11,    27,    -5,   -11,    15,    15,   -11,   -11,
     -11,     2,    27
  };
  ...
  {
       2,     0,     1,     3,     0,     0,     0,     4,     0,     0,
       6,     0,     7,     5,    14,     0,     0,     0,     0,     0,
       0,     0,    15,    16,     0,     8,    11,    10,    12,    13,
       9,     0,    17
  };
  ...
  parser::yytable_[] =
  {
      14,    15,     6,    30,     2,     8,    31,     7,    23,     9,
      26,    27,    28,    29,     3,    10,    11,    12,    16,     4,
      20,    21,    17,    32,    18,    19,    20,    21,     0,    22,
      18,    19,    20,    21,    25
  };
  ...
  parser::yycheck_[] =
  {
       8,     9,    12,     8,     0,     3,    11,    10,    16,     7,
      18,    19,    20,    21,    10,    13,    14,    15,     7,    15,
       5,     6,     9,    31,     3,     4,     5,     6,    -1,     8,
       3,     4,     5,     6,    15
  };
  ...
  parser::yystos_[] =
  {
       0,    18,     0,    10,    15,    19,    12,    10,     3,     7,
      13,    14,    15,    20,    20,    20,     7,     9,     3,     4,
       5,     6,     8,    20,    21,    15,    20,    20,    20,    20,
       8,    11,    20
  };
  ...
  parser::yyrline_[] =
  {
       0,    65,    65,    66,    67,    71,    79,    84,    89,    95,
     101,   107,   113,   119,   125,   130,   138,   141
  };
