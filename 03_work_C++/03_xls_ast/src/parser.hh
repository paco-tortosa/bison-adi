...
# if 201103L <= YY_CPLUSPLUS
  ...
  private:
    ...
    union union_type
    {
      ...
      // expr
      char dummy2[sizeof (std::shared_ptr<cExpr_t>)];
      ...
      // args
      char dummy4[sizeof (std::vector<std::shared_ptr<cExpr_t>>)];
    };
        ...
        switch (this->kind ())
    {
      ...
      case symbol_kind::S_expr: // expr
        value.move< std::shared_ptr<cExpr_t> > (std::move (that.value));
        break;
      ...
      case symbol_kind::S_args: // args
        value.move< std::vector<std::shared_ptr<cExpr_t>> > (std::move (that.value));
        break;
...
#if 201103L <= YY_CPLUSPLUS
      basic_symbol (typename Base::kind_type t, std::shared_ptr<cExpr_t>&& v, location_type&& l)
        : Base (t)
        , value (std::move (v))
        , location (std::move (l))
      {}
#else
      basic_symbol (typename Base::kind_type t, const std::shared_ptr<cExpr_t>& v, const location_type& l)
        : Base (t)
        , value (v)
        , location (l)
      {}
...
#if 201103L <= YY_CPLUSPLUS
      basic_symbol (typename Base::kind_type t, std::vector<std::shared_ptr<cExpr_t>>&& v, location_type&& l)
        : Base (t)
        , value (std::move (v))
        , location (std::move (l))
      {}
#else
      basic_symbol (typename Base::kind_type t, const std::vector<std::shared_ptr<cExpr_t>>& v, const location_type& l)
        : Base (t)
        , value (v)
        , location (l)
      {}
...
switch (yykind)
    {
      ...
      case symbol_kind::S_expr: // expr
        value.template destroy< std::shared_ptr<cExpr_t> > ();
        break;
      ...
      case symbol_kind::S_args: // args
        value.template destroy< std::vector<std::shared_ptr<cExpr_t>> > ();
        break;
    ...
    struct symbol_type : basic_symbol<by_kind>
    {
      ...
      {
#if !defined _MSC_VER || defined __clang__
        YY_ASSERT ((token::TOK_ID <= tok && tok <= token::TOK_CELL));
#endif
      }
    };

    /// Build a parser object.
    parser (cDriver_t& cDriver_yyarg);
    virtual ~parser ();
    ...
    // Implementation of make_symbol for each token kind.
      ...
      static
      symbol_type
      make_CELL (std::string v, location_type l)
      {
        return symbol_type (token::TOK_CELL, std::move (v), std::move (l));
      }
#else
      static
      symbol_type
      make_CELL (const std::string& v, const location_type& l)
      {
        return symbol_type (token::TOK_CELL, v, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
    ...
    , location (that.location)
  {
    switch (this->kind ())
    {
      ...
      case symbol_kind::S_expr: // expr
        value.copy< std::shared_ptr<cExpr_t> > (YY_MOVE (that.value));
        break;
      ...
      case symbol_kind::S_args: // args
        value.copy< std::vector<std::shared_ptr<cExpr_t>> > (YY_MOVE (that.value));
        break;
  ...
  parser::basic_symbol<Base>::move (basic_symbol& s)
  {
    ...
    switch (this->kind ())
    {
      ...
      case symbol_kind::S_expr: // expr
        value.move< std::shared_ptr<cExpr_t> > (YY_MOVE (s.value));
        break;
      ...
      case symbol_kind::S_args: // args
        value.move< std::vector<std::shared_ptr<cExpr_t>> > (YY_MOVE (s.value));
        break;
